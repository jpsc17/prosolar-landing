...
export function CommercialSection() {
  ...
  return (
    <section id="comercial" className="py-16 sm:py-28 bg-white" ref={ref}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-4 sm:mt-14 sm:grid-cols-2 sm:gap-6 lg:grid-cols-4">
          {ADVANTAGES.map(({ icon: Icon, title, desc }, i) => (
            <div
              key={title}
              className={`group relative rounded-2xl border border-border bg-white p-5 shadow-sm transition-all duration-500 hover:-translate-y-1.5 hover:shadow-xl hover:border-solar/30 sm:p-7 ${
